package com.maxwellnie.velox.sql.core.natives.database.table;
...
import com.maxwellnie.velox.sql.core.natives.database.resultset.parser.ResultSetParser;
...
public class TableInfo {
     ...
     * 返回类型映射
     */
    private final Map<Class<?>, Map<String, ReturnTypeMapping>> returnTypeMappingMap = new HashMap<>();
    /**
     * 结果集解析器
     */
    ...
    public Map<String, ReturnTypeMapping> getReturnTypeMappingMap(Class<?> mappedClazz) {
        return returnTypeMappingMap.get(mappedClazz);
    }
    ...
    public void registerReturnTypeMapping(Class<?> clazz, String key, ReturnTypeMapping returnTypeMapping) {
        returnTypeMappingMap.computeIfAbsent(clazz, k -> new HashMap<>()).put(key, returnTypeMapping);
    }

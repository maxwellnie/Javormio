...
public interface MethodExecutor {
     ...
     */
    void check(TableInfo tableInfo, Session session, Object[] args) throws ExecutorException;
     ...
     * @throws ExecutorException
     */
    StatementWrapper openStatement(RowSql rowSql, Session session, TableInfo tableInfo, Object[] args) throws ExecutorException;

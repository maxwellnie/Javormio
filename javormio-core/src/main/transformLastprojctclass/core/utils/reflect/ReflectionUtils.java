...
import com.maxwellnie.velox.sql.core.proxy.factory.DefaultProxyObjectFactory;
import com.maxwellnie.velox.sql.core.proxy.factory.ProxyObjectFactory;
import com.maxwellnie.velox.sql.core.proxy.parser.ProxyInfoParser;
import com.maxwellnie.velox.sql.core.proxy.parser.SimpleProxyInfoParser;
...
public abstract class ReflectionUtils {
    ...
    private static final ProxyInfoParser PROXY_INFO_PARSER = new SimpleProxyInfoParser();
    private static final ProxyObjectFactory<Object> PROXY_OBJECT_FACTORY = new DefaultProxyObjectFactory();
    private static final List<String> PROXY_CLASS_PREFIX = Arrays.asList(
     ...
     * @return MetaField
     */
    public static MetaField getMetaField(Class<?> clazz, String field) {
        return getMetaField(clazz, getField(clazz, field));
    }
}

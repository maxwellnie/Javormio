...
import io.github.maxwellnie.javormio.framework.common.java.api.Constants;
...
import static io.github.maxwellnie.javormio.framework.core.translation.SqlType.isInsert;
import static io.github.maxwellnie.javormio.framework.core.translation.SqlType.isDataModifyingSqlType;
...
public class BatchSqlExecutor extends BaseSqlExecutor {
    ...
    public Object run(ExecutorContext executorContext) throws SQLException, ConvertException {
        ...
        boolean isDataModifyingSqlType = isDataModifyingSqlType(executableSql.getType());
        //消费者----批量更新参数
        Consumer<ResultSet> consumer = (Consumer<ResultSet>) properties.get(Constants.SELECT_GENERATED_KEY);
        //是否需要查询生成的主键----批量添加参数
        boolean selectGeneratedKeys = isDataModifyingSqlType && isInsert(executableSql.getType()) && consumer != null;
        //获取连接对象

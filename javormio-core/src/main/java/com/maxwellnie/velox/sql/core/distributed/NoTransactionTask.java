...
import com.maxwellnie.velox.sql.core.natives.exception.DataSourceConnectionException;
...
public class NoTransactionTask implements TransactionTask {
    ...
    public boolean rollback() {
        for (MetaData metaData : metaDataList) {
            Connections.DataSourceAndConnection dataSourceAndConnection = metaData.getProperty("dataSourceAndConnection");
            Connection connection = null;
            if (dataSourceAndConnection != null && (connection = dataSourceAndConnection.getConnection()) != null) {
                try {
                    connection.rollback();
                } catch (Exception e) {

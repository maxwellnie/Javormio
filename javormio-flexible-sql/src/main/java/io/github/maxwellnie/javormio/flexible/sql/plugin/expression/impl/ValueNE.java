 ...
 * @author Maxwell Nie
 */
public class ValueNE<S  extends SqlExpressionSupport, E, T> extends SingleValueExpression<S, E, T> {
    public ValueNE(ColumnInfo<E, T> firstColumnInfo, T value) {
    ...
    public void applySql(S sqlExpressionSupport, SqlBuilder sqlBuilder, Map<ColumnInfo, String> columnAliases, Map<BaseMetaTableInfo, String> tableAliases) {
        ...
        sqlExpressionSupport.notEq(sqlBuilder, columnName, value, typeHandler, false);
    }
}
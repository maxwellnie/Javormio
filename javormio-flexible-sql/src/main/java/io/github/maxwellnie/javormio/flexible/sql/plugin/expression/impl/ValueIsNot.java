 ...
 * @author Maxwell Nie
 */
public class ValueIsNot<S  extends SqlExpressionSupport, E, T> extends SingleValueExpression<S, E, T> {
    public ValueIsNot(ColumnInfo<E, T> firstColumnInfo, T value) {
    ...
    public void applySql(S sqlExpressionSupport, SqlBuilder sqlBuilder, Map<ColumnInfo, String> columnAliases, Map<BaseMetaTableInfo, String> tableAliases) {
        ...
        sqlExpressionSupport.isNot(sqlBuilder, columnName, value, typeHandler, false);
    }
}
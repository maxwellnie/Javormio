 ...
 * @author Maxwell Nie
 */
public class ValueLE<S  extends SqlExpressionSupport, E, T> extends SingleValueExpression<S, E, T> {
    public ValueLE(ColumnInfo<E, T> firstColumnInfo, T value) {
    ...
    public void applySql(S sqlExpressionSupport, SqlBuilder sqlBuilder, Map<ColumnInfo, String> columnAliases, Map<BaseMetaTableInfo, String> tableAliases) {
        ...
        sqlExpressionSupport.lessEqual(sqlBuilder, columnName, value, typeHandler, false);
    }
}

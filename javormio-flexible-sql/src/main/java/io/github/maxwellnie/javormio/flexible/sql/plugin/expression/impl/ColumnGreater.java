 ...
 * @author Maxwell Nie
 */
public class ColumnGreater<T extends SqlExpressionSupport> extends DoubleColumnExpression<T> {
    public ColumnGreater(ColumnInfo firstColumnInfo, ColumnInfo secondColumnInfo) {
    ...
    public void applySql(T sqlExpressionSupport, SqlBuilder sqlBuilder, Map<ColumnInfo, String> columnAliases, Map<BaseMetaTableInfo, String> tableAliases) {
        ...
        sqlExpressionSupport.greater(sqlBuilder, leftColumnName, rightColumnName, null, true);
    }
}

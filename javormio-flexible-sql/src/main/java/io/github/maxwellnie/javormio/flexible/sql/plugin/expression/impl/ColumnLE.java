 ...
 * @author Maxwell Nie
 */
public class ColumnLE<T extends SqlExpressionSupport> extends DoubleColumnExpression<T> {
    public ColumnLE(ColumnInfo firstColumnInfo, ColumnInfo secondColumnInfo) {
    ...
    public void applySql(T sqlExpressionSupport, SqlBuilder sqlBuilder, Map<ColumnInfo, String> columnAliases, Map<BaseMetaTableInfo, String> tableAliases) {
        ...
        sqlExpressionSupport.lessEqual(sqlBuilder, leftColumnName, rightColumnName, null, true);
    }
}

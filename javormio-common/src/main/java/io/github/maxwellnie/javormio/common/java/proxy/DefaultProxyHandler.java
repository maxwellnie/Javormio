...
import io.github.maxwellnie.javormio.common.java.proxy.invocation.*;
...
public class DefaultProxyHandler implements InvocationHandler {
    ...
    /**
     * 1. If it is an Object method, end directly<br/>
     * 2. If it is a proxy class method, perform the proxy logic<br/>
     * 3. If it is a default method or normal method of the target object, end directly<br/>
     *
     * @return Object
     */
    @Override
